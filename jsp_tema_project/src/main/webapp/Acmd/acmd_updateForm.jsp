...
<body>
    ...
    <div><!-- 메인내용 -->
    <form action="updateAction.ac" method="post" enctype="multipart/form-data">
    <input type="hidden" name="acmd_num" value="${acmd.acmd_num}">
	<input type="hidden" name="pageNum" value="${pageNum }">
	<table class="table"><caption>여행지 작성</caption>
		<tr><th>숙박 이름</th><td colspan="2"><input type="text" name="acmd_name" required="required" autofocus="autofocus" value="${acmd.acmd_name }"></td></tr>
		<tr><th>숙박 간단소개</th><td colspan="2"><input type="text" name="acmd_mini" required="required" value=${acmd.acmd_mini }></td></tr>
		<tr><th>주변 여행지</th><td colspan="2"><input type="text" name="acmd_travel" required="required" placeholder="정확한 여행지 이름입력" value="${acmd.acmd_travel }"></td></tr>
		<tr><th>숙박 내용</th><td colspan="2"><textarea rows="5" cols="40" name="acmd_content" required="required">${acmd.acmd_content }</textarea></td></tr>
