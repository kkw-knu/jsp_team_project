			...
			<div class="fr">
				<div class="private_menu">
					<ul>
						...
						<li><a href="myreview.do" class="sub_menu"> <i
	...
	<div>
		<table class="table">
			...
			<c:if test="${empty list }">
				<tr>
					<th colspan="9" style="text-align: center;">가입한 회원이 없습니다</th>
				</tr>
			</c:if>
			<c:if test="${not empty list }">
				<c:forEach var="member" items="${list }">
					<tr>
						<td title="${member.user_id}">${member.user_id}</td>
						...
						<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<form action="updateAction.mo" method="post">
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 class="modal-title" id="myModalLabel" style="text-align:center;">회원의 모든 정보가 삭제됩니다. 진행하시겠습니까?</h4>
									</div>
								<form action="deleteAction.mo" method="post">
									<input type="hidden" name="user_id" required="required" value="${member.user_id}">
									<input type="hidden" name="pageNum" required="required" value="${currentPage}">
									<div class="modal-footer">
										<button type="button" class="btn btn-default" data-dismiss="modal">닫기</button>
