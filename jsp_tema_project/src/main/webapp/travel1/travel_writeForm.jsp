...
<body>
    ...
    <div><!-- 메인내용 -->
    <form action="writeAction.to" method="post" enctype="multipart/form-data">
    <input type="hidden" name="travel_num" value="${travel_num}">
	<input type="hidden" name="pageNum" value="${pageNum }">
	<table class="table"><caption>여행지 작성</caption>
		<tr><th>여행지 이름</th><td colspan="2"><input type="text" name="travel_name" required="required" autofocus="autofocus"></td></tr>
		<tr><th>여행지 간단소개</th><td colspan="2"><input type="text" name="travel_mini" required="required"></td></tr>
		<tr><th>여행지 내용</th><td colspan="2"><textarea rows="5" cols="40" name="travel_content" required="required"></textarea></td></tr>
		...
		<tr><th colspan="3"><input class="btn btn-primary btn-sm" type="submit" value="작성하기"></th></tr>
	</table>
    </form>
    </div>
    <div class="footer">
