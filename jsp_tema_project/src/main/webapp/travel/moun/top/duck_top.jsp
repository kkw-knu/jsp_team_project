...
<div>
	...
	<div id="duck_img">
		<img class="slide1" src="../../images/mountain/top/duck1.jpg" height="300" width="300"/> 
		<img class="slide1" src="../../images/mountain/top/duck2.jpg" height="300" width="300"/>
		<img class="slide1" src="../../images/mountain/top/duck3.jpg" height="300" width="300"/>
		<img class="slide1" src="../../images/mountain/top/duck4.jpg" height="300" width="300"/>
	</div>
	<p>해발 1,614m의 향적봉으로 정상을 중심으로 백두대간의 산줄기가 뻗어 내리고 있다. 13개의 대(臺), 10여 개의 못, 20개의 폭포 등 기암절벽과 여울들이 아름다움을 뽐내는 무주구천동계곡은 그 옛날 선인들이 이름 붙인 33경으로 지금까지 관광객들에게 사랑받고 있다.</p>
	 <div class="footer">
        <div class="fl">
            <div>
                <div>
