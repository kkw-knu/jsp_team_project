...
<div>
	...
	<div id="beak_img">
		<img class="slide1" src="../../images/mountain/top/baek1.JPG" height="300" width="300"/> 
		<img class="slide1" src="../../images/mountain/top/baek2.JPG" height="300" width="300"/>
		<img class="slide1" src="../../images/mountain/top/baek3.JPG" height="300" width="300"/>
	</div>
	<p> 산 정상의 고산식물과 주목 군락, 6월 초순에 피는 철쭉이 유명하다. 태백산 일출 역시 장관으로 꼽히며, 망경사(望鏡寺) 입구에 있는 용정(龍井)은 한국에서 가장 높은 곳에서 솟는 샘물로서 천제의 제사용 물로 쓰인다.</p>
	 <div class="footer">
        <div class="fl">
            <div>
                <div>
