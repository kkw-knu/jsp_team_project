...
<body>
	...
	<div id="han_img">
		<img class="slide1" src="../../images/mountain/top/seo1.jpg" height="300" width="300"/> 
		<img class="slide1" src="../../images/mountain/top/seo2.jpg" height="300" width="300"/>
		<img class="slide1" src="../../images/mountain/top/seo3.jpg" height="300" width="300"/>
	</div>
	<p> 봄이면 진달래와 철쭉이 만발하고, 여름이면 신록의 푸르름이 협곡과 어우러져 장관을 이룬다. 가을에는 붉게 물든 단풍이 암봉 사이로 불타오르며, 겨울에는 환상의 파노라마를 연출할 정도의 설국을 이룬다.</p>
	<div class="footer">
        <div class="fl">
            <div>
                <div>
