...
<body>
 <div class="global_menu_wrap">
	...
	<div id="han_img">
		<img class="slide1" src="../../images/mountain/top/han1.jpg" height="300" width="300"/> 
		<img class="slide1" src="../../images/mountain/top/han2.jpg" height="300" width="300"/>
		<img class="slide1" src="../../images/mountain/top/han3.jpg" height="300" width="300"/>
	</div>
	<p> 높이 1,947m로 남한에서 가장 높다. 정상에는 둘레 약 3㎞, 지름 500m의 화구호인 백록담(白鹿潭)이 있으며, 주위 사방에 흙붉은오름[土赤岳]·사라오름[砂羅岳]·성널오름[城板岳]·어승생오름[御乘生岳] 등 360여 개의 기생화산을 거느리고 있다. 또 해안지대에는 폭포와 주상절리 등 아름다운 화산지형이 펼쳐지고, 해발고도에 따라 아열대·온대·냉대 등 1,800여 종에 달하는 식물이 자생하여 고도에 따른 식생의 변화가 뚜렷하다. 봄의 철쭉·진달래·유채, 가을의 단풍, 겨울의 설경과 운해가 절경이며, 곳곳에서 한라산의 상징인 노루를 볼 수 있다.</p>
	<div class="footer">
        <div class="fl">
            <div>
                <div>
