...
<div>
	...
	<div id="chi_img">
		<img class="slide1" src="../../images/mountain/cirroad/chi1.jpg" height="300" width="300"/> 
		<img class="slide1" src="../../images/mountain/cirroad/chi2.jpg" height="300" width="300"/>
	</div>
	<p>사람과 자연이 하나되고, 누구나 쉽게 이용할 수 있는 치악산둘레길은 우리의 소중한 자연을 보전하고, 역사와 문화·생태를 체험할 수 있는 길</p>
	<div class="footer">
        <div class="fl">
            <div>
                <div>
