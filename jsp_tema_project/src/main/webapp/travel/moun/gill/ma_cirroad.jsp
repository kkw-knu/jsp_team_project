    ...
    <div style="height: 105px;"></div><!--여백용-->
     <div class="list_menu">
        ...
        <div class="total_sub_menu"><a href="#">공지사항</a></div>
			...
			<div id="ma_cont">
				<h1>마곡사 솔바람길(충남 공주)</h1>
			</div>

			<div id="ma_img">
					<img class="slide1" src="../../images/mountain/cirroad/ma1.jpg" height="300" width="300"/> 
					<img class="slide1" src="../../images/mountain/cirroad/ma2.jpg" height="300" width="300"/> 
			</div>
