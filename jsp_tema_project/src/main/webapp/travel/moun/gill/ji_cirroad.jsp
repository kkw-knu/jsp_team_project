...
<div>
    ...
    <div style="height: 105px;"></div><!--여백용-->
     <div class="list_menu">
		...
		<div id="ji_img">
			<img class="slide1" src="../../images/mountain/cirroad/ji1.jpg" height="300" width="300"/> 
			<img class="slide1" src="../../images/mountain/cirroad/ji2.jpg" height="300" width="300"/> 
		</div>
			<p>지리산 둘레를 잇는 길에서 만나는, 자연과 마을, 역사와 문화의 의미를 다시 찾아내 잇고 보듬는 길 21개의 코스로 숲길,강변길,논둑길,마을길등이 있다.	</p>
