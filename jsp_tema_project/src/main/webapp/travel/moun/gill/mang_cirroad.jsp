    ...
    <div style="height: 105px;"></div><!--여백용-->
     <div class="list_menu">
        ...
        <div class="total_sub_menu"><a href="#">공지사항</a></div>
			...
			<div id="ma_img">
					<img class="slide1" src="../../images/mountain/cirroad/mang1.jpg" height="300" width="300"/> 
					<img class="slide1" src="../../images/mountain/cirroad/mang2.jpg" height="300" width="300"/> 
			</div>
	
			<p>산과 바다를 볼수있고 찬물뜰 전망대,숲하늘길, 바우세 전망대, 모시밭꼴길 전망대, 대봉전망대와 같은 5개 전망대가 있다 </p>
