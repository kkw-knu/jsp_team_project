    ...
    <div style="height: 105px;"></div><!--여백용-->
     <div class="list_menu">
        ...
        <div class="total_sub_menu"><a href="#">공지사항</a></div>
			...
			<div id="jang_img">
					<img class="slide1" src="../../images/mountain/cirroad/jang1.jpg" height="300" width="300"/> 
					<img class="slide1" src="../../images/mountain/cirroad/jang2.jpg" height="300" width="300"/> 
			</div>
	
			<p>울창한 삼나무 숲으로 이루어진 절물자연휴양림 안에 형성된 자연 그대로의 흙길이다	</p>
		<div class="footer">
        <div class="fl">
            <div>
                <div>
