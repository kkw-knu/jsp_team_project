    ...
    <div style="height: 105px;"></div><!--여백용-->
     <div class="list_menu">
        ...
        <div class="total_sub_menu"><a href="#">공지사항</a></div>
			...
			<div id="oh_img">
					<img class="slide1" src="../../images/mountain/cirroad/oh1.jpg" height="300" width="300"/> 
					<img class="slide1" src="../../images/mountain/cirroad/oh2.jpg" height="300" width="300"/> 
			</div>
	
			<p>담양의 북쪽에 해당되며 담양호와 금성산성이 연계하고 있어 주변 경치를 즐기면서 자연과 하나가 될 수 있는 최고의 산책코스</p>
