    ...
    <div style="height: 105px;"></div><!--여백용-->
     <div class="list_menu">
        ...
        <div class="total_sub_menu"><a href="#">공지사항</a></div>
			...
			<div id="olle_img">
					<img class="slide1" src="../../images/mountain/cirroad/olle1.JPG" height="300" width="300"/> 
					<img class="slide1" src="../../images/mountain/cirroad/olle2.JPG" height="300" width="300"/> 
			</div>
	
			<p>26개의 올레길이 조성되어있고 산과 바다를 모두 볼수있다.</p>
