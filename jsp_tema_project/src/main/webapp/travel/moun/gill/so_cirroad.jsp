    ...
    <div style="height: 105px;"></div><!--여백용-->
     <div class="list_menu">
        ...
        <div class="total_sub_menu"><a href="#">공지사항</a></div>
			...
			<div id="so_img">
					<img class="slide1" src="../../images/mountain/cirroad/so1.jpg" height="300" width="300"/> 
					<img class="slide1" src="../../images/mountain/cirroad/so2.jpg" height="300" width="300"/> 
			</div>

			<p>산과 강이 어울러진 절경을 볼수있다	</p>
