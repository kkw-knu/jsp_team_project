...
<div>
	...
	<div id="nami_img">
		<img class="slide1" src="../images/cul/nami1.jpg" height="300" width="300"/> 
		<img class="slide1" src="../images/cul/nami2.jpg" height="300" width="300"/>
		<img class="slide1" src="../images/cul/nami3.jpg" height="300" width="300"/>
		<img class="slide1" src="../images/cul/nami4.jpg" height="300" width="300"/>
	</div>
	<p> 넓은 잔디밭이 전개되어 있고 둘레에 밤나무숲이 무성하고, 별장·방갈로·수영장 등 오락시설이 잘 정비되어 있으며, 서울과 가까워 많은 관광객이 찾아든다. 백자작나무길, 잣나무길, 메타 세콰이어길 등 운치있는 숲길이 명소이다. 드라마 '겨울 연가'의 촬영장소로 알려져 있다.</p>
	<div class="footer">
        <div class="fl">
            <div>
                <div>
