...
<div>
	...
	<div id="susung_img">
		<img class="slide1" src="../images/cul/susung1.jpg" height="300" width="300"/> 
		<img class="slide1" src="../images/cul/susung2.jpg" height="300" width="300"/>
		<img class="slide1" src="../images/cul/susung3.jpg" height="300" width="300"/>
		<img class="slide1" src="../images/cul/susung4.jpg" height="300" width="300"/>
	</div>
	<p> 수성못 주변에는 벤치와 수목, 산책로 유람선 선착장, 우주선, 유람선, 바이킹, 범버카, 회전목마 등의 놀이시설을 갖춘 수성랜드가 어우러져 유원지를 형성되어 있다.</p>
	 <div class="footer">
        <div class="fl">
            <div>
                <div>
