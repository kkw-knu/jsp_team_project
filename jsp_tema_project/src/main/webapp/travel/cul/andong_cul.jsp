...
<div>
	...
	<div id="andong_img">
		<img class="slide1" src="../images/cul/andong1.jpg" height="300" width="300"/> 
		<img class="slide1" src="../images/cul/andong2.jpg" height="300" width="300"/>
		<img class="slide1" src="../images/cul/andong3.jpg" height="300" width="300"/>
		<img class="slide1" src="../images/cul/andong4.jpg" height="300" width="300"/>
	</div>
	<p> 전통적인 유교문화가 살아 숨쉬고 있는 상징공간으로 손꼽히는 곳으로써 가장 한국적이며 독창적인 문화를 간직한 씨족마을입니다.</p>
	 <div class="footer">
        <div class="fl">
            <div>
                <div>
