...
<body>
 <div class="global_menu_wrap">
	...
	<div id="gwang_img">
		<img class="slide1" src="../../images/sea/beach/gwang1.JPG" height="300" width="300"/> 
		<img class="slide1" src="../../images/sea/beach/gwang2.JPG" height="300" width="300"/>
		<img class="slide1" src="../../images/sea/beach/gwang3.JPG" height="300" width="300"/>
	</div>
	<p> 부산의 랜드 마크인 광안 대교가 있으며, 동쪽에는 300여 개의 횟집이 몰려 있는 민락 회 타운 시장이 자리하고 있다.</p>
	<div class="footer">
        <div class="fl">
            <div>
                <div>
