...
<body>
 <div class="global_menu_wrap">
	...
	<div id="ham_img">
		<img class="slide1" src="../../images/sea/beach/ham1.JPG" height="300" width="300"/> 
		<img class="slide1" src="../../images/sea/beach/ham2.JPG" height="300" width="300"/>
		<img class="slide1" src="../../images/sea/beach/ham3.JPG" height="300" width="300"/>
	</div>
	<p> 눈부신 모래밭과 맑은 에머랄드 빛의 바다, 검은 현무암 위에 가로 놓여 있는 아치형 구름다리, 빨간 등대 등이 잘 어우러지면서 아름다운 풍경을 연출하여 ‘한국의 몰디브’라는 별칭이 있다. </p>
	<div class="footer">
        <div class="fl">
            <div>
                <div>
