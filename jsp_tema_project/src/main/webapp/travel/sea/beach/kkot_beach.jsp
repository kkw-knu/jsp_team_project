...
<div class="global_menu_wrap">
	...
	<div id="kkot_img">
		<img class="slide1" src="../../images/sea/beach/kkot1.JPG" height="300" width="300"/> 
		<img class="slide1" src="../../images/sea/beach/kkot2.JPG" height="300" width="300"/>
		<img class="slide1" src="../../images/sea/beach/kkot3.JPG" height="300" width="300"/>
	</div>
	<p> 넓은 백사장과 완만한 수심, 맑고 깨끗한 바닷물, 알맞은 수온과 울창한 소나무숲으로 이루어져 해마다 100만 명이 넘는 피서객들로 붐빈다. 물이 빠지면 갯바위가 드러나 조개·고둥·게·말미잘 등을 잡을 수 있다. 오른편에는 전국에서 낙조로 가장 유명한 할미바위와 할아비바위가 있어서 연중 사진작가들이 찾고 있다.</p>
	<div class="footer">
        <div class="fl">
            <div>
                <div>
