...
<body>
	...
	<div id="nam_img">
		<img class="slide1" src="../../images/sea/view/nam1.jpg" height="300" width="300"/> 
		<img class="slide1" src="../../images/sea/view/nam2.jpg" height="300" width="300"/>
		<img class="slide1" src="../../images/sea/view/nam3.jpg" height="300" width="300"/>
		<img class="slide1" src="../../images/sea/view/nam4.jpg" height="300" width="300"/>
	</div>
	<p>양양군에서 가장 큰 항구이며, 항구를 중심으로 남애1~4리 4개의 포구 마을이 길게 늘어서 있다. 동해시의 추암(湫岩) 일출과 함께 동해안 일출의 최고 명소로 꼽히며, 특히 그림 같은 해변과 아담한 항구를 붉게 물들이며 타오르는 해돋이가 장관이다.	</p>
	<div class="footer">
        <div class="fl">
            <div>
                <div>
