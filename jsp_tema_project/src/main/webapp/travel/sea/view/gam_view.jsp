...
<body>
	...
	<div id="gam_img">
		<img class="slide1" src="../../images/sea/view/gam1.jpg" height="300" width="300"/> 
		<img class="slide1" src="../../images/sea/view/gam2.jpg" height="300" width="300"/>
		<img class="slide1" src="../../images/sea/view/gam3.jpg" height="300" width="300"/>
		<img class="slide1" src="../../images/sea/view/gam4.jpg" height="300" width="300"/>
	</div>
	<p>감은사지 3층석탑을 음각화한 아름다운 등대가 우뚝 솟아있는 감포항은 드나드는 어선이 많은 동해남부의 중심 어항이다.감포항 방파제는 동해 일출을 감상하기에 좋은 포인트로 예전부터 널리 알려져 왔다.	</p>
	<div class="footer">
        <div class="fl">
            <div>
                <div>
