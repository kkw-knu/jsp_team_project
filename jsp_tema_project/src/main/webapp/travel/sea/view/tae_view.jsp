...
<body>
	...
	<div id="tae_img">
		<img class="slide1" src="../../images/sea/view/tae1.jpg" height="300" width="300"/> 
		<img class="slide1" src="../../images/sea/view/tae2.jpg" height="300" width="300"/>
		<img class="slide1" src="../../images/sea/view/tae3.jpg" height="300" width="300"/>
		<img class="slide1" src="../../images/sea/view/tae4.jpg" height="300" width="300"/>
	</div>
	<p> 부산 일대에서 보기 드문 울창한 숲과 기암 괴석으로 된 해식절벽 및 푸른 바다 등이 조화를 이룬다. </p>
	<div class="footer">
        <div class="fl">
            <div>
                <div>
