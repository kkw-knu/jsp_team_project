...
<body>
	...
	<div id="hae_img">
		<img class="slide1" src="../../images/sea/view/hae1.JPG" height="300" width="300"/> 
		<img class="slide1" src="../../images/sea/view/hae2.JPG" height="300" width="300"/>
		<img class="slide1" src="../../images/sea/view/hae3.JPG" height="300" width="300"/>
		<img class="slide1" src="../../images/sea/view/hae4.JPG" height="300" width="300"/>
	</div>
	<p>바다와 절이 어우러진 멋진 풍경인 곳</p>
	<div class="footer">
        <div class="fl">
            <div>
                <div>
