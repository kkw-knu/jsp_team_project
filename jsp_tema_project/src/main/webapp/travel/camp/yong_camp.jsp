...
<div>
	...
	<div id="yong_img">
		<img class="slide1" src="../images/camp/yong1.JPG" height="300" width="300"/> 
		<img class="slide1" src="../images/camp/yong2.JPG" height="300" width="300"/>
		<img class="slide1" src="../images/camp/yong3.JPG" height="300" width="300"/>
	</div>
	<p> 애국가 배경지이자 용담호와 금강이 마주하는 지점의 천년송이 있고 조용한 강가에서 느긋한 여유를 즐길수 있다. </p>
