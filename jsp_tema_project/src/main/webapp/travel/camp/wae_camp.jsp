...
<body>
  <div>
	...
	<div id="wae_img">
		<img class="slide1" src="../images/camp/wae1.JPG" height="300" width="300"/> 
		<img class="slide1" src="../images/camp/wae2.JPG" height="300" width="300"/>
		<img class="slide1" src="../images/camp/wae3.JPG" height="300" width="300"/>
	</div>
	<p> 국내에서 유일하게 일출과 일몰을 한 곳에서 볼수있는 특별한 여행지다.</p>
	<div class="footer">
        <div class="fl">
            <div>
                <div>
