...
<body>
	...
	<div id="juk_img">
		<img class="slide1" src="../images/camp/juk1.JPG" height="300" width="300"/> 
		<img class="slide1" src="../images/camp/juk2.JPG" height="300" width="300"/>
		<img class="slide1" src="../images/camp/juk3.JPG" height="300" width="300"/>
	</div>
	<p> 국내 3대 서핑 스팟중 하나인 '양양 죽도해변' 이곳의 캠핑장에 머무르며 서핑을 즐길수있다.</p>
	 <div class="footer">
        <div class="fl">
            <div>
                <div>
